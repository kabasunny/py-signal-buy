...
def runLassoFeatureSelector(
    ...
    # 特徴量を選択
    selected_features_df = lasso_selector.select_features(df, target_column)
...
if __name__ == "__main__":
    ...
    runLassoFeatureSelector(
        data_path, target_data_path, alpha=0.01, target_column="label"
    )
